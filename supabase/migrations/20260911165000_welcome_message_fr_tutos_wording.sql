-- LayerPitch — ajuste le paragraphe tutos du texte français de mark_onboarding_complete()
-- (20260911164000_welcome_message_real_text.sql) : Jules-Antoine préfère mentionner que les
-- tutos sont pour l'instant en franglais, avec une porte ouverte pour une version FR si besoin,
-- plutôt que la blague sur l'accent. Texte anglais inchangé. Toujours aucun compte réel n'avait
-- reçu le message au moment de cette migration (vérifié avant d'écrire ceci).
